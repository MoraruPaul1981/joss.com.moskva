...
@Named
@ApplicationScoped
public class GetSessionFactoryGatt {


    @Produces
    @Singleton
    @InSessionFactoryGatt
    public SessionFactory getsessionHibernateGatt() {
        ...
        try {
            ...
            switch (Name.trim()) {
                case "PcProgram":
                    configuration.configure("hibernate_gatt.cfg.xml");
                    break;
                default:
                    configuration.configure("hibernate_gatt_r.cfg.xml");
                    break;
            }
