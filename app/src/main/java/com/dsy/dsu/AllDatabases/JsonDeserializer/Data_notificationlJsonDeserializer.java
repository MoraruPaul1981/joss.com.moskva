 ...
 return  РезультатОперацииBurkUPDATE.size();
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindString(2, jsonNodeParentMAP.get("message").asText());//"date_update"
            sqLiteStatementInsert.bindString(3, jsonNodeParentMAP.get("date_start").asText());//"date_update"
            ...
            sqLiteStatementInsert.bindString(11, jsonNodeParentMAP.get("type_tasks").asText());//"date_update"
            sqLiteStatementInsert.bindString(12, jsonNodeParentMAP.get("head_message").asText());//"date_update"
