...
public class MainActivity_Tabel_Single_PeopleGridLau extends AppCompatActivity  {
                        ...
                        try {
                            ...
                            if (  searchViewДляНовогоПоиска.getQuery().toString().length()>5 ) {
                                ...
                                if (ПровйдерСменаПрофесии>0) {
                                    ...
                                    Toast.makeText(MainActivity_Tabel_Single_PeopleGridLau.this, "Профессия не сменилась !!! ", Toast.LENGTH_SHORT).show();
                                }
                            }
