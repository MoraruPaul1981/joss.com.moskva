    ...
    private void МетодПереходимВТабельСотрудники(Button v) {
        try{
         ...
         ///   ИнтентЗапускаемСуществующийТабель.putExtra("МесяцТабеляФиналИзВсехСотрудниковВТАбеле", String.valueOf( МесяцТабеляФиналИзВсехСотрудниковВТАбеле));
            ...
            ИнтентЗапускаемСуществующийТабель.putExtra("МЕсяцВвидеЦифрыДляКурсора", String.valueOf( МЕсяцВвидеЦифрыДляКурсора));
        ...
        //    ИнтентЗапускаемСуществующийТабель.putExtra("ПолученныйПоследнийМесяцДляСортировкиЕгоВСпиноре", МесяцВСпинореНижней);
          ...
          /*  bundleИзListTabels.putLong("CurrenrsItemUUID", CurrenrsItemUUID);
            bundleИзListTabels.putString("NameCreateCFO",NameCreateCFO);
            bundleИзListTabels.putInt("МЕсяцТабелей",МЕсяцТабелей);
            bundleИзListTabels.putInt("ГодТабелей",ГодТабелей);
            bundleИзListTabels.putInt("Position",Position);
            bundleИзListTabels.putString("NameAllCFOSelecting",NameAllCFOSelecting);
            bundleИзListTabels.putString("MainParentUUID",MainParentUUID);
