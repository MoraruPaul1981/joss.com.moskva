package com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer;
...
import com.dsy.dsu.LayerBunessLogic.SaveBitmapToFile.ClassSaveBitmapToFile;
...
// TODO: 14.09.2023 операций insert and update
        if ( РезультатОперацииBurkUPDATE.size()>0) {
            ...
            Integer РезультатПовышенииВерсииДанных =
                    new SubClassUpVersionDATA(context).upVersionMODIFITATION_ClientRemote(имяТаблицаAsync, context);
