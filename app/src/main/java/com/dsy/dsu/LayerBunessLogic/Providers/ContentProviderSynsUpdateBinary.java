...
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.CfoJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Data_chatJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Data_notificationlJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Data_tabelsJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.DepatmentJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.FioJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Fio_templateJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Get_materials_datalJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Materials_databinaryJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Nomen_vesovlJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.NotificationsJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Order_tcJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.OrganizationJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.ProfJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.RegionJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Settings_tabelsJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.TabelJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.TemplatesJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.TrackJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Type_materialslJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Vid_tcJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.View_onesignalJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.Сhat_usersJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.СhatsJsonDeserializer;
import com.dsy.dsu.LayerBunessLogic.JsonSerializerAndDeserializer.СompanylJsonDeserializer;
        ...
        try{
            ...
            // TODO: 04.07.2023 всзависмомсти какая таблица такой и класс паасринга
                       ...
                       /*         // TODO: 11.09.2023 вторая попытка ROOM внедрить
                          ROOMDatabase roomDatabase=GetApplication.getRoom();
                                РезультатJsonDeserializer=
                            ...
                            public void run() throws Throwable {
                                ...
                                if(РезультатОперацииBurkUPDATE.size()>0 ){
                                    РезультатПовышенииВерсииДанных =
                                            new SubClassUpVersionDATA(getContext()).upVersionMODIFITATION_ClientRemote(table,getContext());
                                            ...
                                            public void accept(List<JsonNode> jsonNodesBuffer500) throws Throwable {
                                                ...
                                                if (РезультатОперацииBurkUPDATE.size() > 0) {
                                                    Integer РезультатПовышенииВерсииДанных =
                                                            new SubClassUpVersionDATA(getContext()).upVersionMODIFITATION_ClientRemote(имяТаблицаAsync, getContext() );
                                                    Log.d(this.getClass().getName(), " РезультатПовышенииВерсииДанных  " + РезультатПовышенииВерсииДанных);
                                                }
                                                Log.d(this.getClass().getName(), "\n" + " class " + Thread.currentThread().getStackTrace()[2].getClassName() + "\n" +
                                                        " metod " + Thread.currentThread().getStackTrace()[2].getMethodName() + "\n" +
