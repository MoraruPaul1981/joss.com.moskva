...
import com.dsy.dsu.LayerBunessLogic.SynsProccessor.AsynsProccessor;
...
// TODO: 05.12.2023 work manager
    ...
    public Long metodStartingSync(  @NotNull Context context) {
      AtomicReference<Long>        ФинальныйРезультатAsyncBackgroud=new AtomicReference<>(0l);
        try{
                        ...
                        ФинальныйРезультатAsyncBackgroud.set( new AsynsProccessor(context,getHiltJaksonObjectMapper,
                                getHiltPortJboss,
                                getHiltPublicId)
                        ...
                        afterCodeAsyncForfwardActivityAsync(context, ФинальныйРезультатAsyncBackgroud.get());
                        ...
                        Log.d(getApplicationContext().getClass().getName(), "\n"
                                ...
                                " Класс в процессе... " + this.getClass().getName() + "\n" +
                                " метод в процессе... " + Thread.currentThread().getStackTrace()[2].getMethodName()
                                + " ФинальныйРезультатAsyncBackgroud.get() " +ФинальныйРезультатAsyncBackgroud.get());
        ...
        return ФинальныйРезультатAsyncBackgroud.get();
    }
