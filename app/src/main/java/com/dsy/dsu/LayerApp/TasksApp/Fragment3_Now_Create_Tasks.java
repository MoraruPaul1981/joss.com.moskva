package com.dsy.dsu.LayerApp.TasksApp;
...
/*    private WorkInfo WorkInfoИнформацияОЗапущенойСлужбеОБЩАЯ;
    ...
    public void onResume() {
        ...
        try {
            ...
            class_generations_public_current_id=new Class_Generations_PUBLIC_CURRENT_ID(getContext());
// TODO: 02.03.2022
...
// TODO: 17.03.2022 ЕЩЕ КУРСОР ДЛЯ СПИНЕРА фио ДЛЯ КОГО СОЗДАНО ЗАДАНИЕ
        ...
        protected  Cursor МетодПолученимТОлькоКоличествоЗадач(Integer ПубличноеIDПолученныйИзСервлетаДляUUID) throws ExecutionException, InterruptedException {
            ...
            try {
                ...
                String[] getWhrere=  new String[]{ПубличноеIDПолученныйИзСервлетаДляUUID.toString(),"5"};
                Курсор_ДляПолученияДАнныхТОлькоДляЗадачВработе   =getAllCursor.getCursor(sql,"view_tasks",  getWhrere);
                    ...
                    linkedBlockingQueueДвеТаблицыСозданиеНовойЗадачи.forEach((ТаблицаОбработки) -> {
                        ...
                        try {
                            ...
                            Long РезультатУвеличинаяВерсияВнутриСамогоТабелСтрудникаПервая=
                                    new SubClassUpVersionDATA(getContext()).upVersionCurentTable(    ТаблицаОбработки,getContext());
...
// TODO: 21.03.2022   type  message  new task
                            ...
                            if (Результат_ВставкиДанныхПриСозданииНовойЗадачи[0] > 0) {
                                ...
                                Integer РезультатПослеВставкиДанныхУвеличиваемВерсиюДанных = afterTheSuccessOftheUpVersion(contentValuesДляСозданияНовойЗадачиДляДвухТаблиц, ТаблицаОбработки);
                                // TODO: 21.03.2022
                                // TODO: 21.03.2022
                                Log.d(this.getClass().getName(),
