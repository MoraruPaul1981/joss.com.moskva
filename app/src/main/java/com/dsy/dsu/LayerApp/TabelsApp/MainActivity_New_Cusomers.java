...
import com.dsy.dsu.LayerBunessLogic.Class_Generations_New_Customers_For_Tabels;
      ...
      protected Long методВставкиВТАблицуФИО(@NotNull  int ТекущееЗначение,
        ...
        Integer ЕслиПробел=        НазваниеФИО.indexOf(" ");
                ...
                Long РезультатВычисляемВреисюДанных =
                        new SubClassUpVersionDATA(getApplicationContext()).upVersionCurentTable(    "fio",getApplicationContext() );
