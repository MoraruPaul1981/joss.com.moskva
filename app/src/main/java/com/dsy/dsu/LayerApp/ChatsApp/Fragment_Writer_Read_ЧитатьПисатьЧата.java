...
import com.dsy.dsu.LayerBunessLogic.SubClass_RetryGEtRowInChatsКлассПроверемЕщеРАзПоявилосЛИПуббличныйUUIDМеждуУчасникамиЧата;
...
import com.dsy.dsu.LayerBunessLogic.Services.Service_Для_ЧатаСменаСтатусаПрочитаноИлиНет;
...
public class Fragment_Writer_Read_ЧитатьПисатьЧата extends Fragment {
    ...
    public void onStart() {
        ...
        try {
            ...
            ПубличныйIDДляФрагмента = new Class_Generations_PUBLIC_CURRENT_ID(getContext()).getPublicIDAllApp(getContext());
